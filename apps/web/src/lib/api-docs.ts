...
export const API_ROUTE_GROUPS: ApiRouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { method: "POST", path: "/api/v1/triggers", summary: "Créer un trigger", permission: "job:write", auth: "user" },
      { method: "PATCH", path: "/api/v1/triggers/{id}", summary: "Modifier un trigger", permission: "job:write", auth: "user" },
      { method: "DELETE", path: "/api/v1/triggers/{id}", summary: "Supprimer un trigger", permission: "job:write", auth: "user" },
      { method: "POST", path: "/api/v1/hooks/{hook_token}", summary: "Webhook / Git push (public)", auth: "hook" },
